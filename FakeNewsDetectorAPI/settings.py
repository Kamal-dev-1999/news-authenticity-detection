...
# GEMINI_API_KEY=""
GEMINI_API_KEY='AIzaSyB5XQH-fAYYAwPGhmqFScYMsdJdfK6Qw4o'
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'templatess'),  # Add this line
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': 'news',       # Your database name
        'USER': 'root',   # Your database username
        'PASSWORD': 'Kamal1395',   # Your database password
